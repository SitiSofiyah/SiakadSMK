            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-danger">
                  ...
                  <?php echo form_open_multipart('data_kelas/update/' .$this->uri->segment(3)); ?>
                    ...
                    <div class="row">
                      <div class="col-md-3">
                        <div class="form-group">
                          ...
                          <input type="text" id="namaKelas" name="namaKelas" class="form-control" value="<?php echo $data_kelas[0]->nama_kelas ?>">
                        </div>
                      </div>
                    </div>
                     <div class="form-group">
                          ...
                          <select  class="form-control" name="jurusan">
                            <option value="<?php echo $data_kelas[0]->id_jurusan ?>"><?php echo $data_kelas[0]->nama_jurusan ?></option>
