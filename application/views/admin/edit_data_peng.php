      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="#pablo">Data Pengumuman</a>
          </div>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-info">
                  ...
                  <?php echo form_open_multipart('data_pengumuman/update/' .$this->uri->segment(3)); ?>
                    ...
                    <div class="row">
                      <div class="col-md-3">
                        <div class="form-group">
                          ...
                          <input type="text" id="tgl_peng" name="tgl_peng" class="form-control" value="<?php echo $data_pengumuman[0]->tgl_pengumuman ?>">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-8">
                        <div class="form-group">
                          ...
                          <input type="text" id="judul" name="judul" class="form-control" value="<?php echo $data_pengumuman[0]->judul ?>">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            <label class="bmd-label-floating"> Isi Tujuan pengumuman</label>
                            <textarea class="form-control" id="isi" name="isi" rows="5"><?php echo $data_pengumuman[0]->isi ?></textarea>
                          </div>
                        </div>
                      </div>
                    </div>
                    <button type="submit" class="btn btn-info pull-right">Simpan</button>
                    <a href="<?php echo base_url('index.php/data_pengumuman/') ?>" class="btn btn-danger">Kembali</a>
                <?php echo form_close(); ?>
