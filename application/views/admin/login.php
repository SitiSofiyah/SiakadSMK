...
<html lang="en" class="no-js">
    ...
    <!-- start: HEAD -->
    <head>
        <title>Admin Login - Sistem Informasi Akademik</title>
        <!-- start: META -->
        <meta charset="utf-8" />
    ...
    <body class="login example2">
        <div class="main-login col-sm-4 col-sm-offset-4">
            <div class="logo">SIAKAD<br> SMK PARAMITHA MOJOKERTO
            </div>
            <!-- start: LOGIN BOX -->
            <div class="box-login">
                
                
                <?php echo form_open('auth_admin/chek_login', 'class="form-login"'); ?>
