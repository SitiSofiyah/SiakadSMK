    ...
    <div class="main-panel">
      ...
      <div class="content">
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-12">
              <a href="<?php echo base_url('index.php/data_jurusan/create') ?>" ><button type="button" class="btn btn-success"><i class="material-icons">add</i> Tambah Jurusan</button></a>
              <div class="card">
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
                        <?php $id=1; foreach ($jur_list as $key) : ?>
                        <tr>
                          <td><?php echo $id ?></td>
                          <td><?php echo $key['nama_jurusan'] ?></td>
                          <td>
                            <a href="<?php echo base_url('index.php/data_jurusan/update/' .$key['id_jurusan']) ?>" class="btn btn-info">Edit</a>
                            <a href="<?php echo base_url('index.php/data_jurusan/delete/' .$key['id_jurusan']) ?>" class="btn btn-danger">Hapus</a>
                          </td>
                        </tr>
                        <?php $id++; endforeach?>
                      </tbody>
