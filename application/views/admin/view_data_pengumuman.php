    ...
    <div class="main-panel">
      ...
      <div class="content">
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-12">
              <a href="<?php echo base_url('index.php/data_pengumuman/create') ?>" ><button type="button" class="btn btn-success"><i class="material-icons">add</i> Tambah Pengumuman</button></a>
              <div class="card">
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
                        <?php $id=1; foreach ($peng_list as $key) : ?>
                        <tr>
                          <td><?php echo $id ?></td>
                          <td><?php echo $key['judul'] ?></td>
                          <td><?php echo $key['isi'] ?></td>
                          <td><?php echo $key['tgl_pengumuman'] ?></td>
                          <td>
                            <a href="<?php echo base_url('index.php/data_pengumuman/update/' .$key['id_pengumuman']) ?>" class="btn btn-info">Edit</a>
                            <a href="<?php echo base_url('index.php/data_pengumuman/delete/' .$key['id_pengumuman']) ?>" class="btn btn-danger">Hapus</a>
                          </td>
                        </tr>
                        <?php $id++; endforeach?>
                      </tbody>
